export const CONST_DEVELOPMENT = 'development';

export const CONST_PRODUCTION = 'production';

export const CONST_ENTRY_MAIN = [ 'app.jsx', 'app.js', 'main.jsx', 'main.js', 'index.jsx', 'index.js' ];
// 默认的生成目录名
export const CONST_BUILT_DIRECTORY = './built';

// -
export const CONST_WEBPACK_HOT = 'webpack-hot-middleware/client?noInfo=true&reload=true';
