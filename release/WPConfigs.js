...
function WPConfig(){(0,_classCallCheck2["default"])(this,WPConfig),this.bail=!0,this.mode="production",this.target="web",this.devtool="cheap-module-eval-source-map",this.resolve={mainFiles:["index","main"],extensions:[".js",".jsx",".json"],modules:[_path["default"].resolve(d,"src/libs"),"node_modules"],alias:{"@utils":_path["default"].join(d,"src/utils"),"@env":_path["default"].join(d,"src/env")}},this.module={rules:[{test:/\.jsx?$/,use:{loader:"babel-loader",options:{presets:["@babel/preset-env","@babel/preset-react"],plugins:["@babel/plugin-proposal-class-properties","@babel/plugin-transform-runtime"]}},include:_path["default"].join(d,"src")// exclude : /(node_modules|bower_components)/,
},{test:/\.s?css$/,use:[{loader:_miniCssExtractPlugin["default"].loader,options:{reloadAll:!0}},{loader:"css-loader",options:{importLoaders:1}},{loader:"sass-loader",options:{}}]},{test:/\.less$/,use:[{loader:_miniCssExtractPlugin["default"].loader,options:{reloadAll:!0}},{loader:"css-loader",options:{importLoaders:1}},{loader:"less-loader"}]}]},this.optimization={minimize:!0,namedChunks:!0,runtimeChunk:"single",// 'multiple'
